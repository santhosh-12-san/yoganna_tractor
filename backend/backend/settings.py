...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-yoganna-tractor-works-key-2026')
...
# Database
# Use PostgreSQL in production/docker if variables are set, otherwise SQLite
DB_NAME = os.environ.get('POSTGRES_DB', 'yoganna_db')
