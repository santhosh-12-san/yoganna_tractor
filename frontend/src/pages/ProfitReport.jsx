...
const ProfitReport = () => {
  ...
  if (loading) return <div style={{ textAlign: 'center', padding: '50px' }}>Loading Profit Breakdown...</div>;
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
        ...
        <h2 style={{ fontSize: '1.25rem', color: 'var(--primary)' }}>Profit Breakdowns</h2>
      </div>
        ...
        <div className="activity-card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px', background: 'var(--bg-main)', borderRadius: 'var(--radius-sm)' }}>
              <span style={{ fontWeight: '600' }}>Total Bookings Logged</span>
              <span style={{ fontWeight: 'bold' }}>{metrics.totalBookings}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px', background: 'var(--bg-main)', borderRadius: 'var(--radius-sm)' }}>
              <span style={{ fontWeight: '600' }}>Completed Bookings</span>
              <span style={{ fontWeight: 'bold', color: 'var(--primary)' }}>{metrics.completedBookings}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px', background: 'var(--bg-main)', borderRadius: 'var(--radius-sm)' }}>
              <span style={{ fontWeight: '600' }}>Cancelled Bookings</span>
              <span style={{ fontWeight: 'bold', color: 'var(--danger)' }}>{metrics.cancelledBookings}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px', background: 'var(--bg-main)', borderRadius: 'var(--radius-sm)' }}>
              <span style={{ fontWeight: '600' }}>Total Customers Profiles</span>
